                            ...
                            <div className="text-white font-bold text-xl">
                                ...
                                <ul className="flex flex-col">
                                    <Link to="/accueil" id="Gest" onClick={() => handleLinkClick('Gest')}>
                                        <li className={`flex select pt-5 pb-3 pl-5 hover:border-r cursor-pointer hover:border-black hover:bg-orange-500 ${activeLink === 'Gest' ? 'active border-black bg-orange-500' : 'inactive'}`}>
                                            <MdManageAccounts className="text-2xl mr-3" /> Gestion des utilisateurs
                                        </li>
                                    </Link>
                                    <Link to="/historique" id="Hist" onClick={() => handleLinkClick('Hist')}>
                                        <li className={`flex select pt-5 pb-3 pl-5 hover:border-r cursor-pointer hover:border-black hover:bg-orange-500 ${activeLink === 'Hist' ? 'active border-black bg-orange-500' : 'inactive'}`}>
                                            <TbHistoryToggle className="text-2xl mr-3" /> Historiques
                                        </li>
                                    </Link>
                                    <Link to="/stock" id="Stoc" onClick={() => handleLinkClick('Stoc')}>
                                        <li className={`flex select pt-5 pb-3 pl-5 hover:border-r cursor-pointer hover:border-black hover:bg-orange-500 ${activeLink === 'Stoc' ? 'active border-black bg-orange-500' : 'inactive'}`}>
                                        ...
                                        <div className={`drop-menu transition duration-800 ease-out ${drop ? 'active' : 'inactive'}`}>
                                            <ul>
                                                <Link to="/parametre" id="para" onClick={() => handleLinkClick('para')}>
                                                    <li className='flex select pt-5 pb-3 pl-5 w-72 hover:border-r cursor-pointer hover:border-black hover:bg-orange-500'>
