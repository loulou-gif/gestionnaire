        ...
        <div className="bg-orange-200">
          <nav className="flex justify-between items-center h-full">
            <div className="flex justify-normal items-center h-full">
              ...
              <div
                className={`font-bold w-60 text-center pt-5 pb-5 hover:bg-orange-300 hover:border-b hover:border-black cursor-pointer ${activeTab === 'tab3' ? 'bg-orange-300 hover:border-b border-b border-black cursor-pointer' : ''}`}
